...
class _Add_Info_List_SearchState extends State<Add_Info_List_Search> {
  ...
  Future<void> get() async {
    ...
    setState(() {
      ...
      all_data_map.forEach((key, value) {
        group_all_data_list.add(value['info'].toString());
      });
              ...
              return Center(
                child: TextButton.icon(
                    onPressed: ()async {
                      ...
                      var doc = await FirebaseFirestore.instance.collection('Add_Info').doc();
