...
class Composition_List_Search extends StatefulWidget {
  ...
  @override
  _Composition_List_SearchState createState() => _Composition_List_SearchState();
}
...
class _Composition_List_SearchState extends State<Composition_List_Search> {
  ...
  Future<void> get() async {
    ...
    var a = await Storage.get_composition();
  ...
  void set() async {
    ...
    await Storage.set_composition(value: all_data_map , updated:  updated );
  }
